...
uniform samplerCube uEnvCubemapTexture;
...
void main()
{
    ...
    vec3 color = texture(uEnvCubemapTexture, v).rgb;
    ...
    {
        SHTemp[gl_WorkGroupID.x * GROUP_NUM + gl_WorkGroupID.y][0] = temp[0][0] + temp[1][0];
        SHTemp[gl_WorkGroupID.x * GROUP_NUM + gl_WorkGroupID.y][1] = temp[0][1] + temp[1][1];
        SHTemp[gl_WorkGroupID.x * GROUP_NUM + gl_WorkGroupID.y][2] = temp[0][2] + temp[1][2];
        SHTemp[gl_WorkGroupID.x * GROUP_NUM + gl_WorkGroupID.y][3] = temp[0][3] + temp[1][3];
        SHTemp[gl_WorkGroupID.x * GROUP_NUM + gl_WorkGroupID.y][4] = temp[0][4] + temp[1][4];
        SHTemp[gl_WorkGroupID.x * GROUP_NUM + gl_WorkGroupID.y][5] = temp[0][5] + temp[1][5];
        SHTemp[gl_WorkGroupID.x * GROUP_NUM + gl_WorkGroupID.y][6] = temp[0][6] + temp[1][6];
        SHTemp[gl_WorkGroupID.x * GROUP_NUM + gl_WorkGroupID.y][7] = temp[0][7] + temp[1][7];
        SHTemp[gl_WorkGroupID.x * GROUP_NUM + gl_WorkGroupID.y][8] = temp[0][8] + temp[1][8];
    }
    barrier();
}