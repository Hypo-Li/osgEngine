...
void main()
{
    ...
    {
        float cellCount = 4;
        float worley0 = 1.0 - worleyNoise2(uvw, cellCount * frequenceMul[0]);
        float worley1 = 1.0 - worleyNoise2(uvw, cellCount * frequenceMul[1]);
        float worley2 = 1.0 - worleyNoise2(uvw, cellCount * frequenceMul[2]);
    ...
    float worley4 = 1.0 - worleyNoise2(uvw, cellCount * 16);
