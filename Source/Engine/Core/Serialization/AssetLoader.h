...
namespace xxx
{
    ...
    protected:
        ...
        virtual void serializeEnumeration(refl::Enumeration* enumeration, void* data, size_t count) override;
        virtual void serializeClass(Object** data, size_t count) override;
