...
namespace xxx
{
    ...
    const Asset::ConstBiMap<GLenum, std::string> ATexture::_sTextureTypeStringMap = {
    ...
    const Asset::ConstBiMap<GLenum, std::string> ATexture::_sTextureFormatStringMap = {
        {GL_RGB, "RGB"},
        {GL_RGBA, "RGBA"},
    ...
    const Asset::ConstBiMap<GLenum, std::string> ATexture::_sPixelFormatStringMap = {
        {GL_RED, "R"},
        {GL_GREEN, "G"},
        {GL_BLUE, "B"},
        {GL_RG, "RG"},
    ...
    const Asset::ConstBiMap<GLenum, std::string> ATexture::_sPixelTypeStringMap = {
        {GL_BYTE, "Byte"},
    ...
    const Asset::ConstBiMap<osg::Texture::FilterMode, std::string> ATexture::_sTextureFilterStringMap = {
    ...
    const Asset::ConstBiMap<osg::Texture::WrapMode, std::string> ATexture::_sTextureWrapStringMap = {
    ...
    osg::ref_ptr<osg::Texture> ATexture::createTextureByType(GLenum type)
    {
        switch (type)
        {
        case GL_TEXTURE_2D:
    ...
    void ATexture::serialize(Json& json, std::vector<char>& binary, std::vector<std::string>& reference) const
    {
    ...
    void ATexture::deserialize(const Json& json, const std::vector<char>& binary, const std::vector<std::string>& reference)
    {
